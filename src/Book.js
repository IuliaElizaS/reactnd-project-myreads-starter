...
class Book extends React.Component {
  ...
  shelfUpdater = (actualBook, selectedShelf) => {this.props.updateShelf (actualBook, selectedShelf)}

  render (){
    return (
      <div className="book">
        <div className="book-top">
          <div className="book-cover" style={{ width: 128, height: 193, backgroundImage: '{this.props.myread.imageLinks.thumbnail}', backgroundSize: 'contain' }}></div>
