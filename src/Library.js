    ...
    return (
      <div className="list-books">
        ...
        <div className="list-books-content">
          <div>
            <Shelf getbooks={this.state.existingBooks} bookshelfTitle='Currently Reading'/>
            <Shelf getbooks={this.state.existingBooks} bookshelfTitle='Want to Read'/>
            <Shelf getbooks={this.state.existingBooks} bookshelfTitle='Read'/>
          </div>
        </div>
      </div>
    )
